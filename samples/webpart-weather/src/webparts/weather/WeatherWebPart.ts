...
export default class WeatherWebPartWebPart extends BaseClientSideWebPart<IWeatherWebPartProps> {
        ...
        <div class="${styles.container}">
          <div class="ms-Grid-row ms-bgColor-themeDark ms-fontColor-white ${styles.row}">
            <div class="ms-Grid-col ms-lg10 ms-xl8 ms-xlPush2 ms-lgPush1">
              ...
              <p class="ms-font-l ms-fontColor-white">${escape(this.properties.location)}</p>
